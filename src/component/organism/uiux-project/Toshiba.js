...
class Toshiba extends React.Component {
    ...
    render(){
        return(
            <>
                <section className='animate__delay-body animate__animated animate__fadeIn flex flex-col lg:flex-row justify-center px-5% md:px-10% xl:px-15% laptop-md:px-18% laptop-lg:px-30% py-10 mt-24 sm:mt-28 xl:mt-40 2xl:mt-10%'>
                ...
                <section className='case-study-w-bg-section bg-light-tertiary-elevation dark:bg-dark-tertiary-elevation animate__delay-body animate__animated animate__fadeIn flex flex-col justify-between px-5% md:px-10% xl:px-15% laptop-md:px-18% laptop-lg:px-30% py-10 mt-10 space-y-16'>
                    ...
                    <CaseStudySectionText className=''
                        ...
                        text = 'The UX Team at TGCS in charge of the end-to-end process of user research and design, consisting of 6 people led by 1 design manager. The UX tasks I supported are mostly research, with some visual design. Please contact me for more details about the my projects.'
                    />
                </section>
                <section className='animate__delay-body animate__animated animate__fadeIn flex flex-col justify-between px-5% md:px-10% xl:px-15% laptop-md:px-18% laptop-lg:px-30% py-10 mt-10 space-y-6'>
                    <div>
                    ...
                    <ul className='mt-2 list-disc pl-4 text-light-primary dark:text-dark-primary space-y-3 lg:space-y-2 font-body-text'>
                        ...
                        <ul className='mt-2 text-light-primary dark:text-dark-primary space-y-3 lg:space-y-0 font-light'>
                            <li>Researched a front-end tool, Storybook, which helps developer better maintain and test the components from the design system, and created a proof of concept to present to PM, design manager & the development team. The objective is to streamline the workflow between the design and development team.</li>    
                        </ul>
                    </ul>
                </section>
                <section className='case-study-w-bg-section bg-light-tertiary-elevation dark:bg-dark-tertiary-elevation animate__delay-body animate__animated animate__fadeIn flex flex-col justify-between px-5% md:px-10% xl:px-15% laptop-md:px-18% laptop-lg:px-30% py-10 mt-10 space-y-16'>
                    <CaseStudySectionText className=''
                        ...
                        text = 'While I did not have a chance to practice my UI Design skills, I learned a lot about the human-centered design process through my research works, and got a better sense to empathize with user needs. This experience indeed helps me become a better UX practitioner, and I am very grateful for this opportunity working at Toshiba.'
                    />
                </section>

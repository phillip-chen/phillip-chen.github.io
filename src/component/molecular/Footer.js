...
class Footer extends React.Component{
    ...
    render(){
        return(
            <footer className='text-light-primary dark:text-dark-primary animate__delay-body-2nd animate__animated animate__fadeIn px-5% md:px-10% xl:px-15% laptop-md:px-18% laptop-lg:px-30% py-5 mb-24 sm:mb-10 lg:mb-0 flex flex-col items-center'>
                <IconNavList />
